...
//   // 🔥 API → Sizes extract
//   const sizes = product.options?.map(o => o.size) || [];

//   // 🔥 API → InStock convert string → boolean
...
//       '20kg': '£75.99',
//     };
//     return priceMap[size] || basePrice;
//   };

//   const currentPrice = selectedSize ? getSizePrice(selectedSize) : basePrice;
//   const numericPrice = parseFloat(currentPrice.replace("£", ""));
//   const totalPrice = (numericPrice * quantity).toFixed(2);
